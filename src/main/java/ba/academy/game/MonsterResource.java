...
public class MonsterResource {
    ...
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response create(MonsterDto dtoAtribute, @Context UriInfo uriInfo)
    {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response updateDiary(MonsterDto dtoAtribute, @PathParam("id") int id, @Context UriInfo uriInfo) {
