...
import ba.academy.game.services.MapService;
...
public class MapResource {
    ...
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response create(MapDto dtoAtribute, @Context UriInfo uriInfo)
    {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response updateDiary(MapDto dtoAtribute, @PathParam("id") int id, @Context UriInfo uriInfo) {
