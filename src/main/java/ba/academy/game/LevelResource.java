...
public class LevelResource {
    ...
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response create(LevelDto dtoAtribute, @Context UriInfo uriInfo)
    {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces(value = MediaType.APPLICATION_JSON)
    public Response updateDiary(LevelDto dtoAtribute, @PathParam("id") int id, @Context UriInfo uriInfo) {
